...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Home", "Nifty 50", "BankNifty","Price Prediction", "Profile", "Feedback","Logout"],
        icons=['house', 'bank', 'kanban', 'cash-coin','emoji-sunglasses','person-rolodex','box-arrow-right'],
    )
...
if selected == "Price Prediction":
    st.markdown('<a href="https://stock-predict-app.herokuapp.com/" target="_self">Click to redirect</a>', unsafe_allow_html=True)
